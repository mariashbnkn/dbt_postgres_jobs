...
table_exists = inspector.has_table('job_summaries', schema=DB_SCHEMA)

if not table_exists:
    create_summary_table_sql = f"""
    CREATE TABLE IF NOT EXISTS {DB_SCHEMA}.job_summaries (
...
sql = f"""
ANALYZE VERBOSE {DB_SCHEMA}.job_summaries; 
"""
